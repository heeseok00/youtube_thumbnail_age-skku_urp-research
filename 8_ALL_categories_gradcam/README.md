...
# 논문 부록용 격자 (그룹당 12장 = 카테고리당 3장)
conda run -n urp_yena python make_appendix_grid.py
```
...
- `gradcam_appendix_{34,65}_12.png`, `samples_appendix_{34,65}_12.csv` — 논문 부록 그림 A2/A3
